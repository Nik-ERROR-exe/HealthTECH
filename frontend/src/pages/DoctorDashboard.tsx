                ...
                <>
                  <div className="glass-card rounded-3xl p-6 border border-border/50">
                    ...
                    {/* ===== MERGE CONFLICT RESOLUTION =====
                         HEAD branch (inline chat thread) is commented out.
                         origin/ui-enhance branch (compact trigger) is active.
                    */}

                    {/* ===== INLINE CHAT THREAD (HEAD) – COMMENTED OUT =====
                    ...
                    ===== END COMMENTED OUT INLINE CHAT THREAD ===== */}

                    {/* Send Message to Patient — Compact Trigger (origin/ui-enhance) */}
