    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
          ...
          <button onClick={() => { setLoading(true); fetchDashboard(); }} className="px-4 py-2 rounded-lg bg-gradient-to-r from-primary to-secondary text-white text-sm">Retry</button>
        </div>
      </DashboardLayout>
    );
  }
      ...
      <DashboardLayout>
        <motion.div initial="hidden" animate="visible" className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4">
            <StatCard title="Total Patients" value={dashData.total_patients} icon={Users} color="primary" change={+5} />
            <StatCard title="Critical" value={dashData.critical_count} icon={AlertTriangle} color="red" change={-2} />
            <StatCard title="High Risk" value={dashData.high_risk_count} icon={Activity} color="orange" change={+8} />
            <StatCard title="Stable" value={dashData.stable_count} icon={TrendingUp} color="emerald" change={+12} />
